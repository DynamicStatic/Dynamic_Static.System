...
namespace System {
    ...
    Keyboard::State::KeySet::reference Keyboard::State::operator[](Key key)
    {
        return mKeys[static_cast<size_t>(key)];
    }
...
namespace System {
    ...
    {
        return mCurrent[key] == Keyboard::State::Down;
    }

    bool Keyboard::held(Key key) const
    {
        return
            mCurrent[key] == Keyboard::State::Down &&
            mPrevious[key] == Keyboard::State::Down;
    }
    ...
    bool Keyboard::pressed(Key key) const
    {
        return
            mCurrent[key] == Keyboard::State::Down &&
            mPrevious[key] == Keyboard::State::Up;
    }

    bool Keyboard::released(Key key) const
    {
        return
            mCurrent[key] == Keyboard::State::Up &&
            mPrevious[key] == Keyboard::State::Down;
    }
